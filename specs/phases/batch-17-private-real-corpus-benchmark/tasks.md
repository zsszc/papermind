...
- [ ] T1 RED：私有路径 ignore、去重 manifest 与不删除文件测试失败。
- [ ] T2 GREEN：实现私有 corpus manifest 与去标识化摘要。
- [ ] T3 RED：SHA-256 UID、DOI 规范化和唯一 evidence 测试失败。
- [ ] T4 GREEN：扩展稳定 UID qrels resolver。
